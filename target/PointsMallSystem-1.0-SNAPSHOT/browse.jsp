...
<%@ page import="com.pointsmallsystem.www.dao.SelectProductsByPage" %>
...
<div class="container">
    <%
        ...
        // 获取当前页需要显示的产品数据
        List<Product> currentProducts = SelectProductsByPage.getProductsByPage(sortBy,sortOrder,currentPage, pageSize);
